            ...
            return (
              <div className="flex">
                ...
                <div className=" rounded-r-md  h-full text-center lg:text-start lg:w-[300px]">
                  <h1 className="p-2">{item?.description || "district not found"}</h1>
                  <div className="flex justify-between mt-5 p-2">
                    <h1 className="bg-gray-300 p-2 ">{item?.visitTime || "! best timeToVisit"}</h1>
                    <h1 className="bg-gray-300 p-2 ">{item?.category || "type not found"}</h1>
                  </div>
