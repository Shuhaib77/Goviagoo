  ...
  return (
    <>
      <div className=" w-100%  lg:ml-16 lg:mr-16 sm:mb-20  ">
        {YourMap.length === 0 ? (
          <h1 className="text-3xl text-red-700 font-bold text-center">
            Plss add destination to create RoadMap
          </h1>
        ) : (
          <div>
                    ...
                    <div className=" rounded-r-md  h-full text-center lg:text-start lg:w-[300px]">
                      ...
                      <div className=" p-3">
                        <h1
                          ...
                          onClick={() => {
                            navigate(
                              `/stay/${item?.location.latitude}/${item?.location.longitude}/${YourMap._id}`
                            );
                          }}
                        >
                          <i
                        ...
                        <h1
                          ...
                          onClick={() => {
                            navigate(
                              `/food/${item?.location.latitude}/${item?.location.longitude}/${YourMap._id}`
                            );
                          }}
                        >
                          {" "}
