    ...
    <>
      ...
      <div className="w-100% ml-20 mr-20 mt-10">
        <h1 className="font-bold text-2xl ml-7 ">Accommadation</h1>
        {
          ...
          <h1  className="text-center font-bold text-2xl text-red-700">no stay Booking yet</h1>:
          <div>
        ...
        <div className="mt-20">
         ...
         <h1 className="text-center font-bold text-2xl text-red-700"> no food booking yett</h1>:
         <div>
